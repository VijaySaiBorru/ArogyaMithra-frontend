...
const DoctorProfile = ({ doctorData }) => {
  ...
  useEffect(() => {
    if (doctorData) {
      setFormData({
        ...
        about: doctorData.hcpData?.about || '',
        password: '',
      });
      ...
      <div className="bg-white p-6 rounded-lg shadow-lg mt-6 relative">
        ...
        <div className="flex items-center gap-8">
          ...
          <div className="space-y-2">
            ...
            <p className="text-lg"><strong>Bio:</strong> {formData.about}</p>
          </div>
        </div>
      </div>
  ...
  <div className="fixed inset-0 bg-black bg-opacity-50 z-50 flex justify-center items-center">
    <div className="bg-white rounded-lg shadow-lg p-6 w-full max-w-lg max-h-[90vh] overflow-y-auto relative">
      ...
      <h3 className="text-xl font-semibold text-center mb-4">Update Doctor Profile</h3>
